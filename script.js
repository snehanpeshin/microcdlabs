function normalizeCatalogChrome() {
  ...
  if (headerActions) headerActions.innerHTML = `<a class="header-cta" href="${prefix}consultation.html">Request consultation</a>`;
  const footer = document.querySelector(".site-footer");
  if (footer) footer.innerHTML = `<div class="footer-brand-block"><img class="footer-logo" src="${prefix}assets/microcd-labs-wordmark.svg?v=boxed" alt="MicroCD Labs" /><p class="company-legal">MicroCD Labs, a division of Karigari Home LLC</p><p>Microfluidic and diagnostic product-development support for research and engineering teams.</p><p>Catalog images are representative. Products are for non-clinical research use unless stated otherwise.</p><a href="mailto:info@microcdlabs.com">info@microcdlabs.com</a></div><div class="footer-link-groups"><div><strong>Company</strong><a href="${prefix}about.html">About</a><a href="${prefix}consultation.html">Contact</a><a href="${prefix}news.html">News</a><a href="${prefix}partners.html">Partners</a><a href="${prefix}careers.html">Careers</a></div><div><strong>Products</strong><a href="${prefix}products.html">Catalog</a><a href="${prefix}recommendations.html">Parts recommendations</a><a href="${prefix}kits.html">Starter kits</a><a href="${prefix}products.html#quote">Request a quote</a></div><div><strong>Policies</strong><a href="${prefix}privacy.html">Privacy</a><a href="${prefix}terms.html">Terms</a><a href="${prefix}refunds.html">Refunds</a><a href="${prefix}accessibility.html">Accessibility</a><a href="${prefix}credits.html">Image credits</a></div><div><strong>Tools</strong><a href="${prefix}tools.html">Tools</a><a href="${prefix}karigari-wellness-lens-instructions.html">Karigari Wellness Lens</a></div></div>`;
}
