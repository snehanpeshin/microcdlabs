...
\begin{frame}[plain]
  ...
  \vfill
  {\footnotesize\color{white} MicroCD Labs \quad | \quad info@microcdlabs.com}
\end{frame}
...
\begin{frame}{Technical background}
  ...
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      ...
      \vspace{1em}
      \pill{Doctoral-level research}\quad
      \pill{Diagnostics industry}

      \vspace{0.6em}
      \pill{Assay development}\quad
      \pill{Academic R\&D}
    \end{column}
